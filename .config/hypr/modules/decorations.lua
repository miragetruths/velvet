...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(595959aa)", "rgba(000000ee)"}, angle = 45 },
            inactive_border = "rgba(000000ee)",
        },

        -- Set to truffe to enable resizing windows by clicking and dragging on borders and gaps
...
-- Effects springs
hl.curve("md3_effects_fast",    { type = "spring", mass = 1, stiffness = 3800, dampening = 123 }) -- ratio 1.0
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 2.5, bezier = "md3_emphasized_accel", style = "slide" })
...
-- Above are custom Animations that I copied from a video of '@saneAspect' on Youtube.