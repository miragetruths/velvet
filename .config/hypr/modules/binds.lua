...
local menu        = "uwsm app -- ~/.config/rofi/launchers/type-5/launcher.sh"
local browser     = "uwsm app -- firefox"
local editor 	  = "uwsm app -- codium"
...
hl.bind(mainMod .. " + SHIFT + SPACE + L", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
-- Screenshot the entire monitor output
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m output"))

-- Screenshot a custom region/area
